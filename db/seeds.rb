...
seller_types = SellerType.create([{ name: 'ИП' }, { name: 'ИП с НДС' }, { name: 'Организация' },
                                  { name: 'Организация с НДС' }])

# sizes = Size.create([{ size: 42 }, { size: 44 }, { size: 46 }, { size: 48 }, { size: 50 }, { size: 52 }])

 product_types = ProductType.create([{ name: 'Платье' }, { name: 'Костюм' }, { name: 'Фрак' }])
...
#                             { name: 'Карина', surname: 'Стукина', email: 'amongus@gmail.con', number: '+375445474967', password: '1234567',
#                               password_confirmation: '1234567', role: 'Admin' }, { name: 'Андрей', surname: 'Фролов', email: 'bigger@gmail.con', number: '+375293334567', password: '1234567', password_confirmation: '1234567', role: 'Admin' }
#                           ])
